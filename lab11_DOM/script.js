...
// changee CSS style, color and font-sozr, to the collected span
...
let newlist = document.createTextNode("Post a student's work")
// join the newlist into newite,
newitem.appendChild(newlist)
// step 3) append as child the newitem into the account
